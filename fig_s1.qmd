...
dir.create("fig_s1_files", showWarnings = FALSE, recursive = TRUE)
```
...
```{r figureS1a_patient_count_heatmap}
...
```{r figureS1b_prior_antibiotic_exposure}
...
```{r figureS1c_naive_control_volcano, fig.height=3, fig.width=7.5,fig.cap = "Volcano plots showing limma differential expression results of AB naive patients and controls at T1-4. The eight most significant proteins are labeled. Blue dots indicate proteins significant at p<0.05."}
...
```{r figureS1d_naive_treated_control_volcano, fig.height=3, fig.width=7.5, fig.cap = "Volcano plots showing limma differential expression results of AB naive and treated patients and controls at T1. The eight most significant proteins are labeled. Blue dots indicate proteins significant at p<0.05."}
