...
conflicted::conflicts_prefer(base::cbind, base::setdiff)

options(stringsAsFactors = FALSE, bitmapType = "cairo")
knitr::opts_chunk$set()

dir.create("fig_s3_files", showWarnings = FALSE, recursive = TRUE)
```
