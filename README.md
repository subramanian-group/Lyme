...
# Replace the summary with latest abstract from the manuscript 
...
# check the names and numbers of the supplementary tables generated by the scripts
...
# use "cache" or "object" consistently throughout
